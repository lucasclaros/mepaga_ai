...
class MockInterceptor extends InterceptorsWrapper {
  ...
  static const _routes = [
    _MockRoute(method: 'POST', pathSuffix: '/user/login',             assetPath: 'assets/mock_data/login_success.json'),
    _MockRoute(method: 'POST', pathSuffix: '/user/register',          assetPath: 'assets/mock_data/register_success.json'),
    _MockRoute(method: 'POST', pathSuffix: '/user/validate-code',     assetPath: 'assets/mock_data/otp_success.json'),
    ...
    _MockRoute(method: 'POST', pathSuffix: '/user/platform/add',      assetPath: 'assets/mock_data/platform_register_success.json'),
    _MockRoute(method: 'POST', pathSuffix: '/user/platform/validate', assetPath: 'assets/mock_data/otp_success.json'),
    _MockRoute(method: 'GET',  pathSuffix: '/user/platform/',         assetPath: 'assets/mock_data/platform_check_success.json'),
    _MockRoute(method: 'PATCH', pathSuffix: '/user/pix-key',          assetPath: 'assets/mock_data/pix_register_success.json'),
    ...
    _MockRoute(method: 'PATCH', pathSuffix: '/tickets/',              assetPath: 'assets/mock_data/ticket_price_success.json'),
    _MockRoute(method: 'POST', pathSuffix: '/byma/validate',          assetPath: 'assets/mock_data/byma_validate_success.json'),
    _MockRoute(method: 'POST', pathSuffix: '/payment/charge',         assetPath: 'assets/mock_data/payment_charge.json'),
