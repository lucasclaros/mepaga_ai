...
class AddEmailPlatform extends StatefulWidget {
  ...
  @override
  State<AddEmailPlatform> createState() => _AddEmailPlatformState();
}

class _AddEmailPlatformState extends State<AddEmailPlatform> {
